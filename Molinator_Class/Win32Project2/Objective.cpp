...
Objective::Objective(int ID, char vertexFileName[MAX_FILE_LENGTH], LPDIRECT3DDEVICE9 *device, _D3DCOLORVALUE color, Vector traverse) {
...
Objective::Objective (const Objective &copy) {
